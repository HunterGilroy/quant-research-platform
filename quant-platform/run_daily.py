...
{f"""<div class="status" style="background:#eef2fb"><b>Construction:</b> {meta['method']}
&nbsp;·&nbsp; tournament Sharpe: {', '.join(f"{m} {s:+.2f}" for m, s in meta['sharpes'].items())}
&nbsp;·&nbsp; predicted vol {meta['ex_ante_vol']:.1%} → exposure {meta['vol_scale']:.0%}, cash {meta['cash_weight']:.0%}</div>""" if meta else ""}
