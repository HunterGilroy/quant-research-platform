"""
qrp.universe — The research universe: S&P 500 constituents.

IDENTICAL to the AI bot's universe (trader/universe.py in the sandbox-trader
repo) so the two systems compete on exactly the same playing field. Tickers
are in yfinance format (dashes: BRK-B); the broker layer converts to Alpaca
format (dots: BRK.B) at order submission.

Snapshot of index membership — refresh from
https://en.wikipedia.org/wiki/List_of_S%%26P_500_companies before a new
experiment run if needed.
"""
...
SP500 = [
    ...
    "TECH", "TEL", "TER", "TFC", "TGT", "TJX", "TMO", "TMUS", "TPL", "TPR",
